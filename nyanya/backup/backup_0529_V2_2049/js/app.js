...
function openStockModal(id = null) {
    ...
    if (id) {
        ...
        document.getElementById('s-ingr').value   = s.ingr   || '';
        ...
        ['s-name','s-ingr','s-note'].forEach(id => document.getElementById(id).value = '');
...
function saveStock() {
    ...
    const obj = {
        name, madeDate,
        ingr:       document.getElementById('s-ingr').value.trim(),
